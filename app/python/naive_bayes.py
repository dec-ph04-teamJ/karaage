...
def train_data_1():
  ...
  colleague = ["おはようございます！", "お疲れ様です！", "夜遅くにすみません！", "忙しい時にすみません！", 
              ...
              "そうか、じゃあ、私も同じく家でのんびり過ごすよ。お互いリフレッシュして、また来週から頑張ろうね。", 
              "そうだね、また来週からよろしくね。", 
              ]
  ...
  friend = ["おはよう！", "お疲れ！", "夜遅くにごめん！", "忙しい時にごめん！", 
            ...
            "それはいいな。次は彼女を紹介してくれよ。", 
            "いいよ、それなら一緒に飲みに行こうか。" 
            "最近、自分で作った料理をSNSにアップするのが流行ってるじゃん。俺もやってみたいんだ。ああ、それか。俺はもう何回かやってるけど、俺が勝つと思うなよ。", 
  ...
  couple = ["おはよー", "おつかれちゃん", "夜になったね♡", "いま忙しい？？", 
            "今日はありがとう、楽しかったわ。", 
            "いや、こちらこそ、楽しかったよ。また今度、一緒に遊びに行こうね。", 
            "そうね、次はどこに行きたい？", 
            "いろいろ考えてるけど、どうかな？公園に行ってピクニックでもしながら、のんびり過ごすのも良さそうじゃない？", 
            ...
            "俺もそう思うよ。君と出会えて、本当に幸せなんだ。これからも、ずっと一緒にいたい。",
